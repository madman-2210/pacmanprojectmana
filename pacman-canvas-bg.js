...
function geronimo() {
	...
	function addHighscore() {
		...
		$("#highscore-form").html("Запазване на резултата...");
	...
	function Game() {
		...
		this.newGame = function () {
			var r = confirm("Искаш ли да рестартираш играта?");
			if (r) {
